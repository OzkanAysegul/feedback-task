...
jsPsych.plugins['lmdlab-fullscreen'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'lmdlab-fullscreen',
    description: '',
    parameters: {
      fullscreen_mode: {
      ...
      message: {
        ...
        pretty_name: 'Message',
        default: '<p style="font-size: 2.5rem">The experiment will switch to full screen mode when you press the button below</p><br>',
        array: false,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (keyboardNotAllowed) {
      ...
      if(trial.fullscreen_mode){
        display_element.innerHTML = trial.message + '<button id="jspsych-fullscreen-btn" class="lmdlab-btn">'+trial.button_label+'</button>';
