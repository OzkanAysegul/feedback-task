...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      prompt: {
        ...
        pretty_name: 'Prompt',
        default: null,
        description: 'Please provide estimations of time delays for this target stimuli.'
      },
      stimulus_duration: {
        type: jsPsych.plugins.parameterType.INT,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '"></img>';
    html += '</div>';
    html += '<br><br>' + '<div class="jspsych-image-slider-response-container" style="position:relative; margin: 0 auto 3em auto; ';
