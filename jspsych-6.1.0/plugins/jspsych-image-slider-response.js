...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = '<div id="jspsych-image-slider-response-wrapper" style="margin: 40px 0px;  height: 100%; width = 100%">';
    ...
    // add submit button
    html += '<button id="jspsych-image-slider-response-next" class="jspsych-btn"  style="margin: 50px 0px;  height: 100%; width = 200%">'+trial.button_label+'</button>';
